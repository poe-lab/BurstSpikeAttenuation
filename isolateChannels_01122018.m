function isolateChannels_01122018(placeCellsChannel)
...
for i=1:size(cellIdentity, 1)
    ...
    if placeCellLogic
        newMaxAmp(i) = bursts.maxAmp(i, placeCellsChannel(placeCellidx,3));
        newlastTo1stAmpRatio(i) = bursts.lastTo1stAmpRatio(i, placeCellsChannel(placeCellidx,3));
    end
end
